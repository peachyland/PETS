...
OUT_PATH="./results/brumo_results_${GROUP_ID}.jsonl"
N=128
...
# brumo aime25 aime24 hmmt
MY_CMD="python hmmt.py --model_name ${MODEL_NAME} --out ${OUT_PATH} --n ${N} --max_new_tokens ${MAX_NEW_TOKENS} --group_size ${GROUP_SIZE} --group_id ${GROUP_ID} --temperature ${TEMPERATURE} --top_p ${TOP_P} --seed ${SEED} --batch_size ${BATCH_SIZE}"
