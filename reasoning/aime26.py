#!/usr/bin/env python3
"""AIME 2026 inference and evaluation."""
...
def main():
    ...
    ap.add_argument(
        "--data_path",
        default="MathArena/aime_2026",
        help="Local JSONL path or HuggingFace dataset name (default: opencompass/AIME2025)",
    )
    ap.add_argument("--out", default="aime26_preds.jsonl", help="Output JSONL path")
    args = ap.parse_args()
    ...
    common.run_inference(dataset, process, args.out, args.max_workers, desc="AIME 2026")
