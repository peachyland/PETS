#!/usr/bin/env python3
"""CMIMC inference and evaluation."""
...
def main():
    ...
    ap.add_argument(
        "--data_path",
        default="MathArena/cmimc_2025",
        help="Local JSONL path or HuggingFace dataset name (default: opencompass/AIME2025)",
    )
    ap.add_argument("--out", default="cmimc_preds.jsonl", help="Output JSONL path")
    args = ap.parse_args()
    ...
    common.run_inference(dataset, process, args.out, args.max_workers, desc="CMIMC 2025")
